...
const LandingMovie = ({ quote, movie, image, fixed = true }: propsType) => {
  return (
    <div
      className={`md:h-screen h-[50vh] bg-gray-200  bg-center bg-cover bg-no-repeat snap-y  relative  z-30 ${
        fixed && "md:bg-fixed"
      } ${image} `}
    >
